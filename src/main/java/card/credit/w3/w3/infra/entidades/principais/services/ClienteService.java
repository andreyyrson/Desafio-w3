package card.credit.w3.w3.infra.entidades.principais.services;
...
public class ClienteService {
	...
	public ClienteService(ClienteRepository clienteRepository, CartaoRepository cartaoRepo) {
	...
	private void validarCliente(Cliente cliente) {
		...
		validarRenda(BigDecimal.valueOf(cliente.getRendaMensal()));
	}
	...
	public List<Cartao> buscarPorCpf(String cpf) {
    	return cartaoRepo.buscarPorCpf(cpf);
	}
